...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Sistem Informasi Peminjaman Ruangan"
    />
    <meta name="keywords" content="Peminjaman Ruangan" />
    <meta name="theme-color" content="#1A374D" />
    <link rel="icon" href="logooo.ico" />
    ...
    <title>Peminjaman Ruangan | {{$title}} </title>
  </head>
  <body>
