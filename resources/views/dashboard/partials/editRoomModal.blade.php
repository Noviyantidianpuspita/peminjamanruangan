                ...
                <form action="/dashboard/rooms/{{ $room->code }}" method="post" enctype="multipart/form-data" id="editform">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="type" id="type" required>
                            ...
                            <option value="Ruang Kelas" {{ old('type') === 'RuangKelas' ? 'selected' : '' }}>Ruang Kelas</option>
                            <option value="Gedung Serba Guna" {{ old('type') === 'GedungSerbaGuna' ? 'selected' : '' }}>Gedung Serba Guna</option>
                        </select>
                    </div>
                    <div class="mb-3">
